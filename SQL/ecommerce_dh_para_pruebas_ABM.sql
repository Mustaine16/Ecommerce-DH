/*===================================
  ...
  ESTE SCRIPT ES UNA MODIFICACION DEL  ecommerce_dh.sql
  PARA PODER PROBAR EL ABM YA QUE al marcas.id no poder ser null
  no se podia insertar productos.
  los cambios son : marcas.id pasa a ser NULL y
  productos agrega una columan id_marca int(11) que no pose'ia
...
CREATE TABLE `compras` (
  ...
  PRIMARY KEY (`id`),
  CONSTRAINT `id_producto` FOREIGN KEY (`id`) REFERENCES `productos` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `id_usuario` FOREIGN KEY (`id`) REFERENCES `usuarios` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE `productos` (
  ...
  `sist_operativo` varchar(45) DEFAULT NULL,
...
-- Dump completed on 2020-01-29 23:51:20
